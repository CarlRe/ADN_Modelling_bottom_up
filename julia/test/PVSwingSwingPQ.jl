...
buses = OrderedDict(
      ...
      "bus2" => SwingEqLVS(H=5., P=0., D=1., Ω=50., Γ=20., V=1.0),
      "bus3" => SwingEqLVS(H=5., P=0.2, D=1., Ω=50., Γ=20., V=1.0),
      "bus4" => PQAlgebraic(P=-0.2,Q=-0.001)
      );  
...
timespan= (0.0,10.)
fault = PowerPerturbation(node= "bus4",fault_power=-0.4,tspan_fault = (2.,4.),var=:P)
...
plot_v= plot(sol.dqsol.t,v_sim');plot!(sol1.dqsol.t,v_sim1')
